...
public:
    ...
    void setSacadCommand(const QString& sacadComamnd) override;
    QString sacadCommand() override;

    void setSacadCommandOptionsList(const QStringList& sacadComamndOptionsList) override;
