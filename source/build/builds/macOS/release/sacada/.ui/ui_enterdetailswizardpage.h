...
public:
    ...
    void setupUi(QWizardPage *EnterDetailsWizardPage)
    {
        if (EnterDetailsWizardPage->objectName().isEmpty())
            EnterDetailsWizardPage->setObjectName(QString::fromUtf8("EnterDetailsWizardPage"));
        ...
        pixelsLabel->setObjectName(QString::fromUtf8("pixelsLabel"));
        ...
        albumArtistLineEdit->setObjectName(QString::fromUtf8("albumArtistLineEdit"));
        ...
        sacadCommandLabel->setObjectName(QString::fromUtf8("sacadCommandLabel"));
        sacadCommandLabel->setGeometry(QRect(20, 164, 141, 24));
        sacadCommandLineEdit = new QLineEdit(EnterDetailsWizardPage);
        sacadCommandLineEdit->setObjectName(QString::fromUtf8("sacadCommandLineEdit"));
