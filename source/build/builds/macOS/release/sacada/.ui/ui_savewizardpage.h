...
public:
    ...
    void setupUi(QWizardPage *SaveWizardPage)
    {
        if (SaveWizardPage->objectName().isEmpty())
            SaveWizardPage->setObjectName(QString::fromUtf8("SaveWizardPage"));
        ...
        finalPathLineEdit->setObjectName(QString::fromUtf8("finalPathLineEdit"));
        ...
        discSubfolderInformationLabel->setObjectName(QString::fromUtf8("discSubfolderInformationLabel"));
        ...
        discSubfolderInformationPushButton->setObjectName(QString::fromUtf8("discSubfolderInformationPushButton"));
        discSubfolderInformationPushButton->setGeometry(QRect(640, 200, 181, 35));
        isFinalPathValidCheckBox = new QCheckBox(SaveWizardPage);
        isFinalPathValidCheckBox->setObjectName(QString::fromUtf8("isFinalPathValidCheckBox"));
