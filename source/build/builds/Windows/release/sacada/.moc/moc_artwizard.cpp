...
#include "../../../../../../views/artwizard/artwizard.h"
...
namespace {
struct qt_meta_tag_ZN9ArtWizardE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9ArtWizardE = QtMocHelpers::stringData(
    "ArtWizard",
    "artDetailsUpdated",
    "",
    "albumArtist",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ArtWizardE[] = {
...
Q_CONSTINIT const QMetaObject ArtWizard::staticMetaObject = { {
    QMetaObject::SuperData::link<QWizard::staticMetaObject>(),
    qt_meta_stringdata_ZN9ArtWizardE.offsetsAndSizes,
    qt_meta_data_ZN9ArtWizardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ArtWizardE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ArtWizard, std::true_type>,
...
void ArtWizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { bool _r = _t->artDetailsUpdated((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3])));
        ...
        case 3: _t->saveArtRequested((*reinterpret_cast< std::add_pointer_t<QList<bool>>>(_a[1]))); break;
        ...
        case 8: _t->handlePageChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = bool (ArtWizard::*)(const QString & , const QString & , int );
            if (_q_method_type _q_method = &ArtWizard::artDetailsUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = bool (ArtWizard::*)(const QString & );
            if (_q_method_type _q_method = &ArtWizard::finalPathUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ArtWizard::*)();
            if (_q_method_type _q_method = &ArtWizard::findArtRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (ArtWizard::*)(const QList<bool> & );
            if (_q_method_type _q_method = &ArtWizard::saveArtRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (ArtWizard::*)();
            if (_q_method_type _q_method = &ArtWizard::openTempArtRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (ArtWizard::*)();
            if (_q_method_type _q_method = &ArtWizard::openFinalArtRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (ArtWizard::*)();
            if (_q_method_type _q_method = &ArtWizard::setLocationsRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
...
void *ArtWizard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ArtWizardE.stringdata0))
