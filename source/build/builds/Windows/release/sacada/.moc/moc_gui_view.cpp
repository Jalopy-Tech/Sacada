...
namespace {
struct qt_meta_tag_ZN7GuiViewE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7GuiViewE = QtMocHelpers::stringData(
    "GuiView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7GuiViewE[] = {
...
Q_CONSTINIT const QMetaObject GuiView::staticMetaObject = { {
    QMetaObject::SuperData::link<View::staticMetaObject>(),
    qt_meta_stringdata_ZN7GuiViewE.offsetsAndSizes,
    qt_meta_data_ZN7GuiViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7GuiViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *GuiView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7GuiViewE.stringdata0))
